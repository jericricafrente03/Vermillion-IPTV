...
@OptIn(ExperimentalTvMaterial3Api::class)
@Composable
fun RegisterScreen(modifier: Modifier = Modifier, viewModel: RegistrationViewModel,  onNavigateToPing:() -> Unit = {}) {
    ...
    Box(
        ...
        Column(
            ...
            TvTextField(
                value = state.ip,
                onValueChange = {
                    viewModel.onEvent(RegistrationFormEvent.IpChanged(it))
                },
            ...
            TvTextField(
                ...
                label = "PORT",
                onValueChange = {
                    viewModel.onEvent(RegistrationFormEvent.PortChange(it))
                },
            ...
            TvTextField(
                ...
                label = "ROOM",
                onValueChange = {
                    viewModel.onEvent(RegistrationFormEvent.RoomChanged(it))
                },
