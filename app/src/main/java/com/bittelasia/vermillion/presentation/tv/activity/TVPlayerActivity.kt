package com.bittelasia.vermillion.presentation.tv.activity
...
import com.bittelasia.vermillion.presentation.tv.control.KCustomToast
import com.bittelasia.vermillion.presentation.tv.fragment.Expiration
import com.bittelasia.vermillion.presentation.tv.fragment.TVChannelListFragment
import com.bittelasia.vermillion.presentation.tv.fragment.TVLoaderFragment
import com.bittelasia.vermillion.presentation.tv.fragment.TVNotificationFragment
import com.bittelasia.vermillion.presentation.tv.fragment.TVPlayerFragment
import com.bittelasia.vermillion.presentation.tv.fragment.TVStatusFragment
import com.bittelasia.vermillion.presentation.tv.fragment.XmppReceiver
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                launch {
                    vm.selectedChannel.collectLatest { ch ->
                        if (ch?.data?.isNotEmpty() == true) {
                            channelList = ch.data as List<ChannelData>
