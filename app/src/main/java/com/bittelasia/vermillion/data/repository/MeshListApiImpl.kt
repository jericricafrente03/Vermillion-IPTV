package com.bittelasia.vermillion.data.repository
...
import com.bittelasia.vermillion.domain.repository.MeshListApi
...
class MeshListApiImpl @Inject constructor(
    ...
    override fun broadcast(): Flow<DataState<BroadCastData>> = flow {
        emit(DataState.Loading())
        try {
