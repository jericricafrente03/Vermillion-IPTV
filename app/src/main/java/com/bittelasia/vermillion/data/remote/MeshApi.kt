package com.bittelasia.vermillion.data.remote

import com.bittelasia.vermillion.data.repository.stbpref.data.STB
import com.bittelasia.vermillion.domain.model.app_item.item.AppItem
import com.bittelasia.vermillion.domain.model.broadcast.Broadcast
import com.bittelasia.vermillion.domain.model.channel.item.Channel
import com.bittelasia.vermillion.domain.model.concierge.item.Concierge
import com.bittelasia.vermillion.domain.model.config.item.SystemConfig
import com.bittelasia.vermillion.domain.model.facilities.category.FacilitiesCategories
import com.bittelasia.vermillion.domain.model.facilities.item.Facilities
import com.bittelasia.vermillion.domain.model.guest.item.Guest
import com.bittelasia.vermillion.domain.model.license.item.LicenseData
import com.bittelasia.vermillion.domain.model.license.response.LicenseDate
import com.bittelasia.vermillion.domain.model.message.item.GetMessage
...
import com.bittelasia.vermillion.domain.model.theme.item.ZoneTheme
import com.bittelasia.vermillion.domain.model.time.Time
import com.bittelasia.vermillion.domain.model.weather.item.GetWeeklyWeatherForecast
